package commando.units.simpleminer;
...
public class SimpleMiner extends MobileUnit {
...
//                }
    ...
    public void send() throws GameActionException {
        if(locationsToSend.size() > 0) {
            ...
            int[] message = {31415926, 3, locationsToSend.get(0).x, locationsToSend.get(0).y, 0, 0, 0};
